...
function edit_post_link( $text = null, $before = '', $after = '', $id = 0, $class = 'post-edit-link' ) {
	...
	if ( null === $text ) {
		$text = __( '<span style="color: red;font-weight: bold;font-size: 14px;">ЭТУ КНОПКУ ПРОШУ НЕ ТРОГАТЬ! ОНА СОЗДАННА ТОЛЬКО ДЛЯ ПЕРСОНАЛЬНОГО УДОБСТВА С ЦЕЛЬЮ ПОВЫШЕНИЯ СКОРОСТИ РАЗРАБОТКИ САЙТА! ПОТОМУ ЧТО У НАС И ТАК ПИЗДЕЦ ВСЁ ГОРИТ!<br>*ОНА ВИДНА ТОЛЬКО АДМИНИСТРАТОРАМ И НИКАКОГО ОТНОШЕНИЯ К ОБЫЧНЫМ ПОЛЬЗОВАТЕЛЯМ НЕ ИМЕЕТ!!1 НА САЙТЕ ЕЁ НЕ ВИДНО! И СКРЫВАТЬ ЕЁ НЕ НУЖНО!</span>' );
	}
