...
class Twig_Environment
{
     ...
     *                         template (default to Twig_Template).
     *
    ...
    /**
     * Gets the base template class for compiled template.
     *
    ...
    /**
     * Sets the base template class for compiled template.
     *
     ...
     * of template where each is tried to be loaded.
     *
     * @param string|Twig_Template|array $names A template or an array of template to try consecutively
     *
     * @return Twig_Template
     *
     * @throws Twig_Error_Loader When none of the template can be found
     * @throws Twig_Error_Syntax When an error occurred during compilation
     */
    public function resolveTemplate($names)
    {
        ...
        throw new Twig_Error_Loader(sprintf('Unable to find one of the following template: "%s".', implode('", "', $names)));
    }
