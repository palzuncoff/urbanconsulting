...
abstract class Twig_Template implements Twig_TemplateInterface
{
     ...
     *
     * It does not return blocks from parent template as the parent
    ...
    protected function getAttribute($object, $item, array $arguments = array(), $type = self::ANY_CALL, $isDefinedTest = false, $ignoreStrictCheck = false)
    {
        ...
        if (!isset(self::$cache[$class]['methods'])) {
            // get_class_methods returns all methods accessible in the scope, but we only want public ones to be accessible in template
            if ($object instanceof self) {
                ...
                foreach ($ref->getMethods(ReflectionMethod::IS_PUBLIC) as $refMethod) {
                    ...
                    // Accessing the environment from template is forbidden to prevent untrusted changes to the environment
