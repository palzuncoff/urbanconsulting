...
return [
     ...
     */
    'routes' => [
        'AxisubsAppStripe' => __DIR__ . '/app/routes.php'
    ],
     ...
     */
    'panels' => [
        'AxisubsAppStripe' => __DIR__ . '/app/panels.php'
    ],
     ...
     */
    'apis' => [
        'AxisubsAppStripe' => __DIR__ . '/app/api.php'
    ],

    /**
     * The view paths to register.
     *
     * E.G: 'AxisubsAppStripe' => __DIR__ . '/views'
     * can be referenced via @AxisubsAppStripe/
     * when rendering a view in twig.
     */
    'views' => [
        'AxisubsAppStripe' => __DIR__ . '/resources/views'
    ],
